...
const connectorMonitoring = async function () {
    ...
    await synthetics.executeHttpStep('Get Access Token', requestAccessToken, validateAccessToken, configAccessToken);
      ...
      let requestConnectorHealth = {
        hostname: FIDC_URL.replace('https://', ''),
        method: 'POST',
        path: `/openidm/system/${MONITORED_COMPONENT}?_action=test`,
        port: '443',
        protocol: 'https:',
        body: "",
      ...
      return await synthetics.executeHttpStep(`Verify Connector: CHSCompany`, requestConnectorHealth, validateConnectorHealth, configConnectorsHealth);
};
