runcmd:
  ...
  - cat /var/tmp/ForgeRock_Identity_Cloud-Monitoring_Demo/prometheus/prometheus.tmpl.yml | sed "s/##API_KEY_ID##/${API_KEY_ID}/g" | sed "s/##API_KEY_SECRET##/${API_KEY_SECRET}/g" | sed "s/##TENANT_DOMAIN##/${TENANT_DOMAIN}/g" > /etc/prometheus/prometheus.yml
