...
variable "fidc_mappings" {
  type    = string
  default = "chsMongoCompanyProfile_alphaOrg,webfilingAuthCode_alphaOrg,webfilingUser_alphaUser" # managedAlpha_user_systemDsbackupAccount & alphaUser_webfilingUser disabled for now
}
