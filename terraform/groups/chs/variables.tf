...
variable "fidc_mappings" {
  type    = string
  default = "chsMongoCompanyProfile_alphaOrg,alphaUser_webfilingUser" # managedAlpha_user_systemDsbackupAccount disabled for now
  # ,webfilingAuthCode_alphaOrg,webfilingUser_alphaUser
}
